...
public class StreamsFilterTweets {
    public static void main(String[] args) {
        ...
        KStream<String, String> filteredTweets = inputTopic.filter(
                (key, jsonTweets) -> extractTweetsFollowersInTweet(jsonTweets) > 1000
        );

        filteredTweets.to("important-tweets");
    ...
    private static Integer extractTweetsFollowersInTweet(String tweets) {
        try {
